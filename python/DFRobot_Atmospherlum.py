...
class DFRobot_Atmospherlum:
  ...
  CMD_GET_DATA            =    0x00 #闁哄秷顫夊畵浣瑰閻樿櫣绠栭柡澶堝劤濞堟垿宕ュ鍥嗙偞娼婚弬鎸庣闁告艾绉撮悺?
  CMD_GET_ALL_DATA         =   0x01 #闁兼儳鍢茶ぐ鍥级閼愁垱绁伴柛蹇嬪姂閸庡瓨瀵奸悩鍐插Τ闁革絻鍔嶉弳鐔煎箲?
  CMD_SET_TIME             =   0x02 #閻犱礁澧介悿鍡涘级閼愁垱绁癛TC闁哄啫鐖煎Λ?
  CME_GET_TIME             =   0x03
  CMD_GET_UNIT             =   0x04 #闁兼儳鍢茶ぐ鍥ㄥ閻樺啿濡抽柛锝冨妼瀹曠喐鎷?
  CMD_GET_VERSION          =   0x05 #闁兼儳鍢茶ぐ鍥偋閸喐鎷遍柛?
  CMD_RESET_DATA           =   0x06
